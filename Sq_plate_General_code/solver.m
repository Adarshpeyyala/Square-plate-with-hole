...
% stresses condition on the stiffness matrix and external force vector    %
%                                                                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
parfor i = 1:nel   % Run the loop over elements
   ...
   [kel, ie, jtermue] = get_element_stiffness_right_side_vector(...
       2*CON(i,:),ndoel,Xn(CON(i,:),:),xn(CON(i,:),:),U,ngpv,xigv,I2,D) ; 

   [rel] = get_element_load_vector(...
    load_type,p,q,Lx,Ly,Tx_1,Tx_2,Ty_1,Ty_2,ndoel,xn(CON(i,:),:),ngps,xigs,I2)
