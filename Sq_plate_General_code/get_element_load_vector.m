...
function [rel] = get_element_load_vector(  ...
    load_type,p,q,Lx,Ly,Tx_1,Tx_2,Ty_1,Ty_2,ndoel,xI,ngps,xigs,I2)
...
%for linear varying load on x direction and uniform distribuyed load in
% y  direction
elseif load_type == 2
